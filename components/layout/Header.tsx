        ...
        {isMobileMenuOpen && (
          <div className="lg:hidden absolute top-full left-0 right-0 bg-white shadow-2xl border-t border-gray-100">
            <div className="container mx-auto px-4 py-6 space-y-4">
              <Link
                href="/oficinas"
                className="block text-gray-700 hover:text-blue-600 font-sans font-semibold py-3 transition-colors border-b border-gray-100"
              ...
              <a 
                href="tel:+5543991852779" 
                className="flex items-center gap-2 text-gray-700 hover:text-blue-600 font-sans font-semibold py-3 transition-colors border-b border-gray-100"
              >
                <Phone className="h-4 w-4" />
                (43) 99185-2779
              </a>
              ...
              <Link href="/cadastro" onClick={() => setIsMobileMenuOpen(false)}>
                <Button className="w-full bg-gradient-to-r from-yellow-400 to-yellow-500 hover:from-yellow-500 hover:to-yellow-600 text-gray-900 font-sans font-bold shadow-lg">
                  Começar Grátis
                </Button>
              </Link>
            </div>
