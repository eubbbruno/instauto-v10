...
export function TopBar({ user, userType, userName, onMenuClick, onSignOut }: TopBarProps) {
  ...
  return (
    <header className="sticky top-0 z-40 bg-[#0B1120]/95 backdrop-blur-xl border-b border-white/8">
        ...
        <div className="flex-1 max-w-xl hidden lg:block">
          <div className="relative">
            ...
            <input
              ...
              className="w-full pl-10 pr-4 py-2 bg-white/5 border border-white/10 rounded-xl text-sm text-white placeholder-white/30 focus:outline-none focus:ring-2 focus:ring-yellow-400/30 focus:border-yellow-400/30 transition-all"
            />
          </div>
        </div>
        ...
        <div className="flex items-center gap-3">
            ...
            <div className="relative" ref={notifRef}>
              <button
                ...
                className="relative p-2.5 hover:bg-white/5 rounded-xl transition-all duration-200 group"
              >
                <Bell className="w-5 h-5 text-white/50 group-hover:text-white/80 transition-colors" />
                {unreadCount > 0 && (
              ...
              {showNotifications && (
                <div className="absolute right-0 mt-2 w-80 sm:w-96 bg-[#111827]/95 backdrop-blur-md rounded-2xl shadow-2xl border border-white/10 overflow-hidden">
                  ...
                  {notifications.length > 0 && (
                    <div className="p-3 border-t border-white/5">
                      <Link
                        ...
                        className="block text-center text-sm font-medium text-yellow-400 hover:text-yellow-300"
            ...
            <div className="relative" ref={userMenuRef}>
              <button
                ...
                className="flex items-center gap-3 p-1.5 hover:bg-white/5 rounded-xl transition-all duration-200"
              >
                <div className="w-9 h-9 rounded-xl bg-gradient-to-br from-yellow-400 to-yellow-500 flex items-center justify-center text-[#0B1120] font-bold shadow-md">
              ...
              {/* User Dropdown */}
              {showUserMenu && (
                <div className="absolute right-0 mt-2 w-56 bg-[#111827]/95 backdrop-blur-md rounded-2xl shadow-2xl border border-white/10 overflow-hidden">
                  <div className="p-4 border-b border-white/8">
                    <p className="font-semibold text-white truncate">{userName || "Usuário"}</p>
                  ...
                  <div className="py-2">
                    ...
                    >
                      ...
                      <span className="text-sm text-white/80">Configurações</span>
                    </Link>
