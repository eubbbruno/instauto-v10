            ...
            <div className="space-y-4">
              ...
              <FadeIn delay={0.3}>
                <Link href="/oficina/diagnostico" className="block">
                  <div className="bg-gradient-to-br from-yellow-400 to-yellow-500 rounded-2xl p-5 shadow-lg hover:shadow-2xl hover:shadow-yellow-500/20 transition-all duration-300 hover:-translate-y-1">
                    <div className="flex items-center gap-3 mb-3">
                      <div className="p-2.5 bg-[#0B1120]/20 rounded-xl">
                        <Sparkles className="w-5 h-5 text-[#0B1120]" />
                      </div>
                      <h3 className="font-black text-base text-[#0B1120]">Diagnóstico com IA</h3>
                    </div>
                    <p className="text-[#0B1120]/60 text-sm mb-4 leading-relaxed">
                      Analise problemas de veículos com inteligência artificial
                    </p>
                    <div className="w-full py-2.5 bg-[#0B1120] text-white rounded-xl text-sm font-bold text-center hover:bg-[#111827] transition-colors">
                      Iniciar Diagnóstico
                    </div>
                  </div>
                </Link>
            ...
            {!isProActive(workshop) && (
              <div className="bg-yellow-50 border border-yellow-200 rounded-2xl p-4">
                <div className="flex items-center justify-between">
                  ...
                  <Link
                    href="/oficina/planos"
                    className="btn-epic px-4 py-2 rounded-lg text-sm font-bold"
                  >
                    Ver Planos
                  </Link>
                </div>
