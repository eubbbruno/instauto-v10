...
import { AlertCircle, CheckCircle, Loader2, Mail, Lock, Building2, Sparkles, Wrench } from "lucide-react";
          ...
          <div className="grid lg:grid-cols-2 gap-8 items-center">
            ...
            <div className="hidden lg:flex flex-col items-center justify-center bg-gradient-to-br from-yellow-500 to-orange-600 rounded-3xl p-12 text-white shadow-2xl backdrop-blur-xl">
              ...
              <p className="text-yellow-100 text-center text-lg leading-relaxed mb-6">
                Sistema completo de gestão + marketplace para atrair novos clientes. Teste grátis por 14 dias!
              </p>
              <div className="space-y-3 w-full max-w-md">
                ...
                <div className="flex items-center gap-3">
                  ...
                  <span className="text-yellow-50">Controle de estoque e financeiro</span>
                </div>
                <div className="flex items-center gap-3">
                  <div className="w-10 h-10 bg-white/20 rounded-full flex items-center justify-center flex-shrink-0">
                    <CheckCircle className="h-5 w-5" />
                  </div>
                  <span className="text-yellow-50">Apareça no marketplace</span>
                </div>
                <div className="flex items-center gap-3">
                  <div className="w-10 h-10 bg-white/20 rounded-full flex items-center justify-center flex-shrink-0">
                    <CheckCircle className="h-5 w-5" />
                  </div>
                  <span className="text-yellow-50">Relatórios e análises</span>
                </div>
              </div>
            </div>
                  ...
                  <CardContent className="space-y-5">
                    ...
                    <div className="bg-blue-50 border-2 border-blue-200 rounded-lg p-4 text-center">
                      <p className="text-sm text-gray-700">
                        É um motorista?{" "}
                        <Link href="/cadastro-motorista" className="font-bold text-blue-600 hover:text-blue-700 underline">
                          Cadastre-se aqui
                        </Link>
                      </p>
                    </div>
